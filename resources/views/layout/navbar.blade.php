        ...
        <div class="flex px-4 justify-end items-center w-full">
            <div>
                ...
                <nav
                   ...
                   id="navbarCollapse"
                   class="absolute right-0 top-full bg-white py-5 px-6 z-50 shadow rounded-lg w-full dark:bg-slate-900 dark:text-gray-300 lg:mx-w-full lg:w-full lg:right-4 lg:block lg:static lg:shadow-none"
                >
